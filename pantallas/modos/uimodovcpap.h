#ifndef UIMODOVCPAP_H
#define UIMODOVCPAP_H
...
class UiModoVCPAP : public QWidget
{
    Q_OBJECT
public:
    explicit UiModoVCPAP();
    QString btn;
    QString btnSeleccionado;
    WidgetParametro * vcpap_cpap;
    WidgetParametro * vcpap_ps;
    WidgetParametro * vcpap_oxi;
    ...
    WidgetParametro * respaldo_vt;
    WidgetParametro * respaldo_flujo;
    QLabel * labelIE;
    QLabel * labelTE;
    QLabel * labelTI;
