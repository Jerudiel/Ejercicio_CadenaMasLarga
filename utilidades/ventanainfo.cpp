...
VentanaInfo::VentanaInfo(QWidget *parent, int width, int height) : QWidget(parent)
{
    try {
...
void VentanaInfo::paintEvent(QPaintEvent* /*event*/){
    try {
       QSize s = size();
...
void VentanaInfo::textoMostrar(QStringList *mensajes){
    try {
