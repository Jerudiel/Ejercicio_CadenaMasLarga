#ifndef VENTANAINOPERANTE_H
#define VENTANAINOPERANTE_H
...
class VentanaInoperante : public QWidget
{
    Q_OBJECT
public:
    explicit VentanaInoperante(QWidget *parent = nullptr, int width=400, int height=500, QString titulo="");
    ...
    void setTitulo(QString nuevo_titulo);
    ...
    void mostrar(QString mensaje);

signals:

};

#endif // VENTANAINOPERANTE_H
