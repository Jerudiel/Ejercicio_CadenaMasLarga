#include "tramavsimv.h"

TramaVSIMV::TramaVSIMV(Formulas *formulas)
{
    try {
        vtinsp = "";
        psoporte = "";
...
void TramaVSIMV::llenar(QStringList parametros, QString alarpmax){
    try {
        vtinsp = parametros.at(1);
        psoporte = parametros.at(2);
        peep = parametros.at(3);
        fr = parametros.at(4);
        flujo = parametros.at(5);
        tincr = parametros.at(6);
        meseta = parametros.at(7);
        oxigeno = parametros.at(10);
        mod_trigger = parametros.at(11);
        trigger_flujo = parametros.at(12);
        trigger_presion = parametros.at(13);
        palarmax = alarpmax;
    }  catch (std::exception &e) {
        qWarning("Error %s desde la funcion %s", e.what(), Q_FUNC_INFO );
    }
...
QString TramaVSIMV::obtener_trama_serpresion_config(){
    try {
        QString modo = "3";
        ...
        //unir
        QString trama = "C" + modo + t_vtinsp + t_peep + t_psoporte + t_fr + t_flujo + t_oxigeno + t_mod_trigger + t_sensibilidad + t_tpausa + "\n";
        if(trama.size() == 25){
...
QString TramaVSIMV::obtener_vtinsp(){
    try {
        QString vt_s = "";
...
QString TramaVSIMV::obtener_peep(){
    try {
        QString peep_s = "";
...
QString TramaVSIMV::obtener_psoporte(){
    try {
        QString ps_s = "";
...
QString TramaVSIMV::obtener_flujo(){
    try {
        QString flujo_s = "";
...
QString TramaVSIMV::obtener_fio2(){
    try {
        QString oxi_s = "";
...
QString TramaVSIMV::obtener_modo_trigger(){
    try {
        if(mod_trigger == "1"){
            return "1";
        }
...
QString TramaVSIMV::obtener_sensibilidad(){
    try {
        QString sensi_s = "";
        QString temp_s = "";
        if(mod_trigger == "1"){
...
QString TramaVSIMV::obtener_tpausa(){
    try {
        QString tp_s = "";
...
QString TramaVSIMV::obtener_trama_ventilador(){
    try {
        QString modo = "3";
        QString t_ti = obt_ti();
        QString t_tp = obt_tp();
...
QString TramaVSIMV::obt_pwm_oxi(){
    try {
...
QString TramaVSIMV::obt_pwm_aire(){
    try {
        int temp = oxigeno.toInt();
...
QString TramaVSIMV::obt_psoporte(){
    try {
        //return "000";
        QString ps_s = "";
        int ps_int = psoporte.toInt();
...
QString TramaVSIMV::obt_palarmax(){
    try {        
        QString pmax_s = "";
