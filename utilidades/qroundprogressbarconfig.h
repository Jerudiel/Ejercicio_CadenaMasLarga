...
#ifndef QROUNDPROGRESSBARCONFIG_H
#define QROUNDPROGRESSBARCONFIG_H
 ...
 */
class QRoundProgressBarConfig : public QWidget
{
    Q_OBJECT
public:
    explicit QRoundProgressBarConfig(QWidget *parent = 0);

    static const int PositionLeft = 160;
    static const int PositionTop = 70;
    static const int PositionRight = 0;
    static const int PositionBottom = -70;
...
#endif // QROUNDPROGRESSBARCONFIG_H
