...
#ifndef QROUNDPROGRESSBARALARM_H
#define QROUNDPROGRESSBARALARM_H
 ...
 */
class QRoundProgressBarAlarm : public QWidget
{
    Q_OBJECT
public:
    explicit QRoundProgressBarAlarm(QWidget *parent = 0);
    ...
    /**
     * @brief Return type of unit
     * \sa
     */
    void setInactive();
    /**
     * @brief Change color inactive
     * \sa
     */
    void setActive();
    /**
     * @brief Change color active
     * \sa
     */
...
protected:
    ...
    static const int UF_DATA = 5;
    int m_updateFlags;

    QString m_unit = "";

    QColor * m_background_color_activo;
    QColor * m_background_color_inactivo;
    QColor * m_background_color;
    QColor * textcolor;
};

#endif // QROUNDPROGRESSBARALARM_H
